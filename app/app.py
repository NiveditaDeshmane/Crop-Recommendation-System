...
st.set_page_config(page_title="Crop Recommendation System", layout="centered",page_icon='🪴🌾')
...
with col2:
    temperature = st.number_input("Temperature (°C) 🌡️", min_value=0.0, max_value=50.0, value=25.5)
    humidity = st.number_input("Humidity (%) ❄️", min_value=0.0, max_value=100.0, value=80.0)
    rainfall = st.number_input("Rainfall (mm) ⛈️", min_value=0.0, max_value=500.0, value=200.0)
